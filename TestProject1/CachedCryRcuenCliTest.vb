...
'''<summary>
'''Se trata de una clase de prueba para CachedCryRcuenCliTest y se pretende que
'''contenga todas las pruebas unitarias CachedCryRcuenCliTest.
'''</summary>
<TestClass()> _
Public Class CachedCryRcuenCliTest
...
#End Region
    ...
    Public Sub ShareDBLogonInfoTest()
        Dim target As ICachedReport = New CachedCryRcuenCli ' TODO: Inicializar en un valor adecuado
    ...
    '''<summary>
    '''Una prueba de Constructor CachedCryRcuenCli
    '''</summary>
    <TestMethod()> _
    Public Sub CachedCryRcuenCliConstructorTest()
        Dim target As CachedCryRcuenCli = New CachedCryRcuenCli

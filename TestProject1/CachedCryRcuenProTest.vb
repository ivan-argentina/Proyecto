...
'''<summary>
'''Se trata de una clase de prueba para CachedCryRcuenProTest y se pretende que
'''contenga todas las pruebas unitarias CachedCryRcuenProTest.
'''</summary>
<TestClass()> _
Public Class CachedCryRcuenProTest
...
#End Region
    ...
    Public Sub ShareDBLogonInfoTest()
        Dim target As ICachedReport = New CachedCryRcuenPro ' TODO: Inicializar en un valor adecuado
    ...
    '''<summary>
    '''Una prueba de Constructor CachedCryRcuenPro
    '''</summary>
    <TestMethod()> _
    Public Sub CachedCryRcuenProConstructorTest()
        Dim target As CachedCryRcuenPro = New CachedCryRcuenPro

...
'''<summary>
'''Se trata de una clase de prueba para CachedCryIvaVentasTest y se pretende que
'''contenga todas las pruebas unitarias CachedCryIvaVentasTest.
'''</summary>
<TestClass()> _
Public Class CachedCryIvaVentasTest
...
#End Region
    ...
    Public Sub ShareDBLogonInfoTest()
        Dim target As ICachedReport = New CachedCryIvaVentas ' TODO: Inicializar en un valor adecuado
    ...
    '''<summary>
    '''Una prueba de Constructor CachedCryIvaVentas
    '''</summary>
    <TestMethod()> _
    Public Sub CachedCryIvaVentasConstructorTest()
        Dim target As CachedCryIvaVentas = New CachedCryIvaVentas

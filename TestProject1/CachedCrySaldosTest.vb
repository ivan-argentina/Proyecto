...
'''<summary>
'''Se trata de una clase de prueba para CachedCrySaldosTest y se pretende que
'''contenga todas las pruebas unitarias CachedCrySaldosTest.
'''</summary>
<TestClass()> _
Public Class CachedCrySaldosTest
...
#End Region
    ...
    Public Sub ShareDBLogonInfoTest()
        Dim target As ICachedReport = New CachedCrySaldos ' TODO: Inicializar en un valor adecuado
    ...
    '''<summary>
    '''Una prueba de Constructor CachedCrySaldos
    '''</summary>
    <TestMethod()> _
    Public Sub CachedCrySaldosConstructorTest()
        Dim target As CachedCrySaldos = New CachedCrySaldos

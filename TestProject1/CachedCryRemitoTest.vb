...
'''<summary>
'''Se trata de una clase de prueba para CachedCryRemitoTest y se pretende que
'''contenga todas las pruebas unitarias CachedCryRemitoTest.
'''</summary>
<TestClass()> _
Public Class CachedCryRemitoTest
...
#End Region
    ...
    Public Sub ShareDBLogonInfoTest()
        Dim target As ICachedReport = New CachedCryRemito ' TODO: Inicializar en un valor adecuado
    ...
    '''<summary>
    '''Una prueba de Constructor CachedCryRemito
    '''</summary>
    <TestMethod()> _
    Public Sub CachedCryRemitoConstructorTest()
        Dim target As CachedCryRemito = New CachedCryRemito

...
'''<summary>
'''Se trata de una clase de prueba para CachedCryDetVenTest y se pretende que
'''contenga todas las pruebas unitarias CachedCryDetVenTest.
'''</summary>
<TestClass()> _
Public Class CachedCryDetVenTest
...
#End Region
    ...
    Public Sub ShareDBLogonInfoTest()
        Dim target As ICachedReport = New CachedCryDetVen ' TODO: Inicializar en un valor adecuado
    ...
    '''<summary>
    '''Una prueba de Constructor CachedCryDetVen
    '''</summary>
    <TestMethod()> _
    Public Sub CachedCryDetVenConstructorTest()
        Dim target As CachedCryDetVen = New CachedCryDetVen

...
'''<summary>
'''Se trata de una clase de prueba para CachedCryReciboTest y se pretende que
'''contenga todas las pruebas unitarias CachedCryReciboTest.
'''</summary>
<TestClass()> _
Public Class CachedCryReciboTest
...
#End Region
    ...
    Public Sub ShareDBLogonInfoTest()
        Dim target As ICachedReport = New CachedCryRecibo ' TODO: Inicializar en un valor adecuado
    ...
    '''<summary>
    '''Una prueba de Constructor CachedCryRecibo
    '''</summary>
    <TestMethod()> _
    Public Sub CachedCryReciboConstructorTest()
        Dim target As CachedCryRecibo = New CachedCryRecibo

...
'''<summary>
'''Se trata de una clase de prueba para CachedCryIvaComprasTest y se pretende que
'''contenga todas las pruebas unitarias CachedCryIvaComprasTest.
'''</summary>
<TestClass()> _
Public Class CachedCryIvaComprasTest
...
#End Region
    ...
    Public Sub ShareDBLogonInfoTest()
        Dim target As ICachedReport = New CachedCryIvaCompras ' TODO: Inicializar en un valor adecuado
    ...
    '''<summary>
    '''Una prueba de Constructor CachedCryIvaCompras
    '''</summary>
    <TestMethod()> _
    Public Sub CachedCryIvaComprasConstructorTest()
        Dim target As CachedCryIvaCompras = New CachedCryIvaCompras

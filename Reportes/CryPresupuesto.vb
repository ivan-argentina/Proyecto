...
Public Class CryPresupuesto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Super.CryPresupuesto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPresupuesto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPresupuesto = New CryPresupuesto
        rpt.Site = Me.Site
        Return rpt
    End Function
